...
import getInterviewsListByContactId from '@salesforce/apex/ContactController.getInterviewsListByContactId';
import getInterviewsListByContactIdForTheCurrentWeek from '@salesforce/apex/ContactController.getInterviewsListByContactIdForTheCurrentWeek';
...
export default class InterviewForAWeekList extends LightningElement {
    ...
    @wire(getInterviewsListByContactId, {contactId : '$recordId'})
    interviews;

    @wire(getInterviewsListByContactIdForTheCurrentWeek, {contactId : '$recordId'})
    interviewsweek;
